...
namespace YakuzaGame.Files.ScenarY0
{
    public class File : BinaryTextFile
    {
        ...
        public override void Rebuild(string outputFolder)
        {
            ...
            using (var output = new ExtendedBinaryWriter(fsOutput, FileEncoding, Endianness.BigEndian))
            {
                ...
                var count3 = input.ReadInt32();
                var offset3 = input.ReadInt32();
                ...
                input.Seek(offset3, SeekOrigin.Begin);
                output.Seek(offset3, SeekOrigin.Begin);
