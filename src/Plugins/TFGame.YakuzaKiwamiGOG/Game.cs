...
namespace TFGame.YakuzaKiwamiGOG
{
    public class Game : YakuzaGame.Game
    {
        ...
        public override string Id => "7f8efe16-87fd-4f5a-a837-cacf3dde2855";
        public override string Name => "Yakuza Kiwami (GOG)";
        public override string Description => "Build Id: 1.0.11a";
