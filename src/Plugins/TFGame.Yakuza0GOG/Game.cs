...
namespace TFGame.Yakuza0GOG
{
    public class Game : YakuzaGame.Game
    {
        public override string Id => "193b8191-39e2-4ad7-b0bf-9cb413bb910e";
        public override string Name => "Yakuza 0 (GOG)";
        ...
        private IList<GameFileContainer> GetPause()
        {
            ...
            {
                Path = @"data\pausepar_e\cabaret_island.par",
                Type = ContainerType.CompressedFile
            };
            ...
            {
                Path = @"data\pausepar_e\chapter.par",
                Type = ContainerType.CompressedFile
            };
            ...
            {
                Path = @"data\pausepar_e\find_arms.par",
                Type = ContainerType.CompressedFile
            };
            ...
            var minigame = new GameFileContainer
            {
                Path = @"data\pausepar_e\minigame.par",
                Type = ContainerType.CompressedFile
            };
            ...
            {
                Path = @"data\pausepar_e\movie.par",
                Type = ContainerType.CompressedFile
            };
            ...
            {
                Path = @"data\pausepar_e\pause.par",
                Type = ContainerType.CompressedFile
            };
            ...
            {
                Path = @"data\pausepar_e\pcircuit.par",
                Type = ContainerType.CompressedFile
            };
            ...
            {
                Path = @"data\pausepar_e\tougijyo.par",
                Type = ContainerType.CompressedFile
            };
